...
function PurchaseForm(props) {
  ...
  if (props.inModal) {
    ...
    return <>
      ...
      <h2 className={styles2.ttl} style={{textAlign: "center"}}> {props.ttl} </h2>
      ...
      <form className={classNames(styles.form, styles2.form)}>
        ...
        <div className={classNames(styles.bottom, styles2.bottom)}>
          ...
          <div className={classNames(styles.col, styles2.col)} style={{flexDirection: "column", alignItems: 'flex-start' }}>

            <GreyButton type="file"><Clip/> Прикерпить файл</GreyButton>
            
            <div className={classNames(styles.note)} style={{marginTop: '12px'}}>Допустимое расширение файлов: .ppt, .pptx, .doc, .docx, .xls, .xlsx, .pdf, .jpg, .jpeg, .png</div>
